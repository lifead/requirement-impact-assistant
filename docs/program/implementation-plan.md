...
- `dotnet build`;
- `dotnet test`;
- локальный smoke run стартовой страницы.
...
- upload `.md`, `.txt`, `.json`;
- сохранение файла в локальный каталог;
- сохранение метаданных;
- извлечение текста как фрагмента контекста;
